...
class TestGame {
	...
	void testInit() {
		...
		assertEquals(PBG.DIMENSION1 / 2, t.getPositionX());
	}
	...
	void testUpdate() {
		...
		assertEquals(PBG.DIMENSION1 / 2, t.getPositionX());
		g.update();
		assertEquals(PBG.DIMENSION1 / 2 + Puddle.DX, t.getPositionX());
		g.update();
		assertEquals(PBG.DIMENSION1 / 2 + 2 * Puddle.DX, t.getPositionX());
	}
