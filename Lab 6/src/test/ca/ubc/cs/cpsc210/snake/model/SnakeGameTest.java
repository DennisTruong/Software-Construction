...
class SnakeGameTest {
    ...
    void testIsGameOverMoveRight() {
        ...
        int distanceToRightWall = SnakeGame.BOARD_COLS - snakePosition.getColumn() - 1;

        for(int i = 0; i < distanceToRightWall; i++) {
    ...
    void testIsGameOverMoveDown() {
        ...
        Cell snakePosition = testSnakeGame.getSnakeHeadPosition();
        int distanceToBottomWall = SnakeGame.BOARD_ROWS - snakePosition.getRow() - 1;

        for(int i = 0; i < distanceToBottomWall; i++) {
            testSnakeGame.update();
        }
